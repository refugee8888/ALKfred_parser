...
CREATE INDEX IF NOT EXISTS idx_label_norm ON dim_disease(label_norm);
...
CREATE INDEX IF NOT EXISTS idx_label_norm ON dim_gene_variant(label_norm);
...
CREATE INDEX IF NOT EXISTS idx_label_norm ON dim_therapy(label_norm);
...
CREATE INDEX IF NOT EXISTS idx_fact_therapy ON fact_evidence(ncit_id);
